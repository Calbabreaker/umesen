    ...
    fn default() -> Self {
        ...
        KeyActionMap {
            map: indexmap::indexmap! {
                ...
                ControllerInput(0, Button::RIGHT) => egui::Key::ArrowRight,
                ControllerInput(0, Button::LEFT) => egui::Key::ArrowLeft,
                ControllerInput(0, Button::UP) => egui::Key::ArrowUp,
                ControllerInput(0, Button::DOWN) => egui::Key::ArrowDown,
                ControllerInput(0, Button::A) => egui::Key::M,
                ControllerInput(0, Button::B) => egui::Key::N,
                ControllerInput(0, Button::SELECT) => egui::Key::K,
                ControllerInput(0, Button::START) => egui::Key::J,
                ControllerInput(1, Button::RIGHT) => egui::Key::D,
                ControllerInput(1, Button::LEFT) => egui::Key::A,
                ControllerInput(1, Button::UP) => egui::Key::W,
                ControllerInput(1, Button::DOWN) => egui::Key::S,
                ControllerInput(1, Button::A) => egui::Key::C,
                ControllerInput(1, Button::B) => egui::Key::X,
                ControllerInput(1, Button::SELECT) => egui::Key::E,
                ControllerInput(1, Button::START) => egui::Key::R,
            },
